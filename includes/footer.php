<footer>
  <div class="footer-grid">
    <div class="footer-brand">
      ...
      <p class="footer-desc">Dein persönliches Finanz-Cockpit. Alles über Konten, Kreditkarten, Investments und Kryptowährungen auf einen Blick. Kostenlos, sicher, DSGVO-konform.</p>
    </div>
    <div>
