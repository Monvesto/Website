...
<section class="section" id="inhalt">
  ...
  <p class="section-intro">Privatpersonen leihen Geld direkt an andere – ohne Bank. Als Anleger erhältst du Zinsen, meist monatlich ausgezahlt.</p>
  <p class="mt-16" style="font-size:16px;color:var(--text-muted);line-height:1.7;">P2P eignet sich als Beimischung (5–15 % des Portfolios) neben ETFs. Die Renditen sind höher als bei Tagesgeld – aber das Risiko ebenfalls. Nie als Hauptinvestment.</p>
</section>
<hr class="divider" />
